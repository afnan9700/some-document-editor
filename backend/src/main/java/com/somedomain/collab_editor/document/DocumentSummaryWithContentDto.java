...
public class DocumentSummaryWithContentDto {
    ...
    public DocumentSummaryWithContentDto(Long documentId, String title, String content, Long ownerId,
    ...
    // public void setLockedByUserId(Long lockedByUserId) { this.lockedByUserId =
    // lockedByUserId; }
    ...
    // public void setLockExpiresAt(Instant lockExpiresAt) { this.lockExpiresAt =
    // lockExpiresAt; }
}
